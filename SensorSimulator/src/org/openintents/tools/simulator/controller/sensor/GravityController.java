...
//		}
	...
	public String getString() {
		GravityModel gravityModel = (GravityModel) mSensorModel;
		return Global.TWO_DECIMAL_FORMAT.format(gravityModel.getGravityX())
				+ ", "
				+ Global.TWO_DECIMAL_FORMAT.format(gravityModel.getGravityY())
				+ ", "
				+ Global.TWO_DECIMAL_FORMAT.format(gravityModel.getGravityZ());
	}
}
