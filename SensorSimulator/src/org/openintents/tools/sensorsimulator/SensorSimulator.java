...
public class SensorSimulator extends JPanel
    ...
    JTextField telnetSocketText;
    JButton telnetSocketButton;
    ...
    JCheckBox mSupportedBarcodeReader;
    ...
    JCheckBox mEnabledBarcodeReader;
    ...
    //Battery variables
    JCheckBox batteryPresence;
    JCheckBox batteryAC;
    JComboBox batteryStatusList;
    JComboBox batteryHealthList;
    
    //Batter file variables
    JButton batteryEmulation;
    JButton batteryNext;
    JFileChooser fileChooser;
    JButton openButton;
    
    //GPS variables
    JTextField gpsLongitudeText;
    JTextField gpsLatitudeText;
    JTextField gpsAltitudeText;
    JTextField lisName;
    JButton gpsButton;
    ...
    public TelnetServer mTelnetServer;
	...
	public SensorSimulator() {
        ...
        c.gridx = 2;
        telnetSocketButton = new JButton("Set");
