...
public class SensorServerThread implements Runnable {
        ...
        try {
	        ...
	        while ((inputLine = in.readLine()) != null) {
	        	...
	        	//////////////////////////////////////////////////////////
	        		...
	        		} else if (inputLine.compareTo(SensorSimulator.BARCODE_READER) == 0
	        				&& mSensorSimulator.mSupportedBarcodeReader.isSelected()) {
	        			out.println("" + mSensorSimulator.mEnabledBarcodeReader.isSelected());
	        			mSensorSimulator.mEnabledBarcodeReader.setSelected(enable);
	        		} else {
	        	...
	        	//////////////////////////////////////////////////////////
	        		...
	        		if (inputLine.compareTo(SensorSimulator.ACCELEROMETER) == 0
	        			...
	        			if (mSensorSimulator.mEnabledTemperature.isSelected()) {
	        				...
	        				&& mSensorSimulator.mSupportedBarcodeReader.isSelected()) {
	        			if (mSensorSimulator.mEnabledBarcodeReader.isSelected()) {

	        				if(mSensorSimulator.mobile.barcode.length()==13){
	        				String sensorData = "1\n"  // number of data following
	        					+ mSensorSimulator.mobile.barcode;
	        				out.println(sensorData);
	        				}else{
	        					String sensorData = "1\n"
	        						+ "1";
    ...
    public String[] getSupportedSensors() {
		...
		if (mSensorSimulator.mSupportedBarcodeReader.isSelected()) {
			sensorList[sensorMax] = SensorSimulator.BARCODE_READER;
			sensorMax++;
		}
